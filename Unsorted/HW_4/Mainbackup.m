...
while Params.time < Params.n_iterations 
    %Choose an epoch
    batch = datasample(1:n_rules_training, Params.K, 'Replace', false);
...
%Training Data
y_list_training = y_list_training * maximum;
...
%%
%This function takes in an integar n, and outputs a 2xn matrix where the
%first column is a number between 0.1 and 1 while the second column is 1/x.
